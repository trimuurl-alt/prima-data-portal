...
export default function AccountPage() {
  ...
  const [tab, setTab] = useState<'password' | 'mfa'>(
    user?.mfaEnabled ? 'password' : 'mfa'
  );
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-stone-200 rounded-xl p-6">
        <div className="space-y-1 text-sm">
          ...
          <div>
            <span className="text-stone-500">Name:</span> {user.fullName}
          </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-stone-500">
        Minimum 10 characters with upper, lower, and a number.
      </p>

      {success && (
        <div className="bg-green-50 text-green-800 text-sm rounded-lg px-3 py-2">
    ...
    return (
      <div className="space-y-4 max-w-md">
        ...
        <details>
          ...
          <code className="block mt-2 text-xs bg-stone-50 border border-stone-200 rounded p-2 break-all font-mono">
            {setupData.secret}
          </code>
        </details>
        ...
        {confirmMfa.isError && (
          <div className="bg-red-50 text-red-700 text-sm rounded-lg px-3 py-2">
            {getErrorMessage(confirmMfa.error)}
          </div>
        )}
    ...
    <div className="space-y-4 max-w-md">
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
        ...
        <p className="text-sm text-amber-700">
          Add an extra layer of security to your account. We strongly recommend
